...
<div class="icon-group">
    <a href="../View/Create.php?action=Delete">Create</a>
</div>
...
<table>
    ...
    <?php foreach ($_SESSION['post'] as $post):?>
        <tr>
            ...
            <td>
                <div class="icon-group">
                    <a href="../Controller/methods.php?id=<?= $post['post_id'] ?>&action=Show">Show</a>
                    <a href="../Controller/methods.php?id=<?= $post['post_id'] ?>&action=get">Update</a>
                    <a href="../Controller/methods.php?id=<?= $post['post_id'] ?>&action=Delete">Delete</a>
                </div>
            </td>
        </tr>
    <?php endforeach; ?>
